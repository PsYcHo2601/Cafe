...
def coffee_list(request):
    ...
    if search_query:
        filtered_coffee = [c for c in coffee if
                           search_query in c["name"].lower() or search_query in str(c["price"]) or search_query in c[
                               "date"]]
    ...
    return render(request, "coffee_list.html",
                  {"coffee": filtered_coffee, "basket_count": len(basket), "search_query": search_query,
